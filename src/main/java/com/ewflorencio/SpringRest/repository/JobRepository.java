package com.ewflorencio.SpringRest.repository;
...
//        return jobs.stream().filter(it -> it.getPostId() == id).findFirst().orElse(null);
//    }
//
//    public void updateJob(JobPost jobPost) {
//        jobs = jobs.stream().map(job -> jobPost.getPostId() == job.getPostId() ? jobPost : job).toList();
//    }
//
//    public boolean delete(int postId) {
//        return jobs.remove(jobs.stream().filter(it -> it.getPostId() == postId).findFirst().orElse(null));
//    }}
